...
class _TextaoState extends State<Previsao> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('Projeto_Previsao').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('Projeto_Previsao').doc(documentId).delete();

...
class _TextaoState extends State<Corte> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('Horarios_de_corte').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('Horarios_de_corte').doc(documentId).delete();

...
class lockFerias extends StatelessWidget {
  @override
...
class LockFerias extends StatefulWidget {
  const LockFerias({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockFerias> {
  String enteredPin = '';
  ...
  void _onSubmitPressed() {
    if (enteredPin == correctPin) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Ferias()), //Trocar a tela
      );
    } else {
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Férias', // Alterar para o nome da tela que vai redirecionar

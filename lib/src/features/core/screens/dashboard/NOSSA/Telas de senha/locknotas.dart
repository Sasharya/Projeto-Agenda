...
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Telas de notas/notas.dart';

class lockNotas extends StatelessWidget {
  @override
...
class LockNotas extends StatefulWidget {
  const LockNotas({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockNotas> {
  String enteredPin = '';
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                '5S', // Alterar para o nome da tela que vai redirecionar

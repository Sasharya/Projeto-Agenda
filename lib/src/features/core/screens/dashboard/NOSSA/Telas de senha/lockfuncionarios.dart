...
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Telas de notas/funcionario.dart';

class lockFuncionarios extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: LockFuncionarios(),
    );
  }
}

class LockFuncionarios extends StatefulWidget {
  const LockFuncionarios({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockFuncionarios> {
  String enteredPin = '';
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Funcionários', // Alterar para o nome da tela que vai redirecionar

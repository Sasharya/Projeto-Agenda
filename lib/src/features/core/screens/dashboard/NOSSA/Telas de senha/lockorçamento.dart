...
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Telas de notas/orçamento.dart';

class lockOrcamento extends StatelessWidget {
  @override
...
class LockOrcamento extends StatefulWidget {
  const LockOrcamento({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockOrcamento> {
  String enteredPin = '';
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Orçamento', // Alterar para o nome da tela que vai redirecionar

...
class lockMelhorias extends StatelessWidget {
  @override
...
class LockMelhorias extends StatefulWidget {
  const LockMelhorias({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockMelhorias> {
  String enteredPin = '';
  ...
  void _onSubmitPressed() {
    if (enteredPin == correctPin) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => Melhorias()),
      );
    } else {
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Melhorias', // Alterar para o nome da tela que vai redirecionar

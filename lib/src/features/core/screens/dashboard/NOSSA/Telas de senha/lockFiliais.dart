...
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Telas de notas/ferias.dart';
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Homescreen.dart';


class lockFiliais extends StatelessWidget {
  @override
...
class LockFiliais extends StatefulWidget {
  const LockFiliais({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockFiliais> {
  String enteredPin = '';
  ...
  void _onSubmitPressed() {
    if (enteredPin == correctPin) {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => FILIAIS()), //Trocar a tela
      );
    } else {
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Filiais', // Alterar para o nome da tela que vai redirecionar

...
import 'package:testeagenda/src/features/core/screens/dashboard/NOSSA/Telas de notas/horariocorte.dart';

class lockCorte extends StatelessWidget {
  @override
...
class LockCorte extends StatefulWidget {
  const LockCorte({Key? key}) : super(key: key);

  @override
  _LockScreenState createState() => _LockScreenState();
}

class _LockScreenState extends State<LockCorte> {
  String enteredPin = '';
        ...
        child: ClipRRect(
          child: BackdropFilter(
            ...
            child: AppBar(
              ...
              centerTitle: true,
              title: const Text(
                'Horario de Corte', // Alterar para o nome da tela que vai redirecionar

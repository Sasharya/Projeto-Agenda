...
class Fatos1031 extends StatefulWidget {
  @override
  _TextaoState createState() => _TextaoState();

}

class _TextaoState extends State<Fatos1031> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('1031fatos').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('1031fatos').doc(documentId).delete();

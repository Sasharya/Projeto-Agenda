...
class Fatos1030 extends StatefulWidget {
  @override
  _TextaoState createState() => _TextaoState();

}

class _TextaoState extends State<Fatos1030> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('1030fatos').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('1030fatos').doc(documentId).delete();

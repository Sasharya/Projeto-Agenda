...
class Fatos1032 extends StatefulWidget {
  @override
  _TextaoState createState() => _TextaoState();

}

class _TextaoState extends State<Fatos1032> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('1032fatos').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('1032fatos').doc(documentId).delete();

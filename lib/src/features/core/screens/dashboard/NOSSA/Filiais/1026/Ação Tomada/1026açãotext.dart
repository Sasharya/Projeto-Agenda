...
class Acao1026 extends StatefulWidget {
  @override
  _TextaoState createState() => _TextaoState();

}

class _TextaoState extends State<Acao1026> {
  ...
  Future<void> _loadNotes() async {
    try {
      QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('1026ação').get();
  ...
  Future<void> _deleteNote(String documentId) async {
    try {
      await FirebaseFirestore.instance.collection('1026ação').doc(documentId).delete();
